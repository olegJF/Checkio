...
'''Время по умолчанию равно 00:00. Обратите внимание, что время
не может быть меньше 00:00 и больше 90:00, даже если add_time
или del_time приводят к подобной ситуации. '''
