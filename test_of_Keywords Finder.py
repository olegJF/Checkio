...
import unittest
from Storage_Keywords_Finder import checkio
...
class PaternTestCase(unittest.TestCase):
    ...
    def test_empty_text(self):
        text =''
        words ='asd'
        self.assertEqual(checkio(text, words), text)
    ...
    def test_words_not_in_text(self):
        TESTS = [
        {
        ...
        {
            "input": ["Python is a widely used high-level programming language.", "pyThoN"],
            "answer": "<span>Python</span> is a widely used high-level programming language."
        },

        {
            "input": ["It is experiment for control groups with similar distributions.", "is im"],
            "answer": "It <span>is</span> exper<span>im</span>ent for control groups with s<span>im</span>ilar d<span>is</span>tributions."
        },

        {
            "input": ["The National Aeronautics and Space Administration (NASA).", "nasa  THE"],
        ...
        {
            "input": ["abcdefghijklmnopqrstuvwxyz", "z y x w v u t s r q p o n m l k j i h g f e d c b a"],
        ...
        for t in TESTS:
            text, words = t['input'][0], t['input'][1]
            answer = t['answer']
            self.assertEqual(checkio(text, words), answer)
            #print('answer', answer)
